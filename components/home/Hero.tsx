...
function MailIcon() {
  return (
    <svg {...ICON_PROPS} className="h-6 w-6 text-white">
...
export function Hero() {
  return (
    <div className="relative flex min-h-[656px] items-end overflow-hidden pb-16 md:min-h-[580px] md:pb-24">
      ...
      <div className="relative z-10 mx-auto w-full max-w-site px-5 md:px-[50px]">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          ...
          >
            <span className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-full bg-brand">
              <MailIcon />
            </span>
            <h4 className="font-ui text-label font-semibold text-white md:text-label-lg">{site.email}</h4>
          </a>
          <a
            href={site.phoneHref}
            className="flex items-center gap-3 rounded-full bg-black/50 py-2.5 pl-[15px] pr-5 backdrop-blur-sm transition hover:opacity-80"
          >
            ...
            <h4 className="font-ui text-label font-semibold text-white md:text-label-lg">{site.phone}</h4>
          </a>
        </div>
      </div>
    </div>
